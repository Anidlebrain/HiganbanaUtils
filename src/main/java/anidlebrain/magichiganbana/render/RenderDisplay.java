package anidlebrain.magichiganbana.render;
    ...
    public void render(TileEntityDisplay tile, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (StackUtil.isValid(stack)) {
            ...
            try {
                ...
                MagicHiganbana.LOGGER.error("Something went wrong trying to render an item in a display stand! The item is " + stack.getItem().getRegistryName() + "!", e);
            }
